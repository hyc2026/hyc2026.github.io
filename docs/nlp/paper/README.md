...
1. **The Factual Inconsistency Problem in Abstractive Text Summarization: A Survey**. *Yichong Huang, Xiachong Feng, Xiaocheng Feng, Bing Qin*. arXiv 2021. [[paper](https://arxiv.org/pdf/2104.14839)]
